...
public class Calculos {
	...
	public static String imprimeFolha(int colabId) {
		...
		folhaGravada = "Cadastro: " + colabId + "\n" + "Nome: " + nomeColab + "\n \n" + "Valor bruto: "
				...
				+ ("Valor horas extras (+): R$ "
						...
						+ calculaImpostoRenda(valorSalarioBruto) + "\n" + "Valor total descontos (-): R$ "
						+ salarioDescontos + "\n \n" + "Valor líquido: R$ " + salarioFinal);
	 ...
	 * 
	 * @param horaComInsalubridade double Valor da hora do colaborador já acrescido
	 *                             da insalubridade.
	...
	public static void main(String[] args) {
		...
		// Alterado para chamar a classe de tela
		// imprimeFolha(101);
		...
		senha.add("LUCAS123");
		tela.telaInicial(usuarios, senha);
